...
class Rover_individual:
    def __init__(self, position: Position, chromosome: list, Best_time:float, genes:list): 
        self.position = position
        self.chromosome = chromosome
        self.genes = genes
        self.fitness, self.time = self.cal_fitness(Best_time) 
    ...
    def mate(self, par2, Best_time): 
        ...
        return Rover_individual(Position(0,0),child_chromosome, Best_time, par2.genes) 
  
    def cal_fitness(self, Best_time):
        time = 0
